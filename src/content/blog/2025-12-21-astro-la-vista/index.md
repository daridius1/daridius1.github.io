...
## ¿Por qué abandonar Astro?

El tema es que todas las cosas bacanes de Astro no sirven realmente para una página que tiene únicamente dos vistas, que cargan de forma dinámica y requieren el uso intensivo de JavaScript. Al final, después de estar un buen rato intentando cachar qué onda con los problemas que iba encontrando, decidí dar un paso atrás y empezar el proyecto con **Vite** y **TypeScript**, usando HTML plano y **GSAP**.

## Los clankers se lucieron
...
Al Jero y a la Milla les gustó, que creo son las opiniones más importantes de cada lado del espectro. El Blaz me dijo que iba a hacer una API para acortar el link y nunca lo hizo (¡esos frijoles estaban rancios!).

## El problema

Por el momento, el tamaño del link es el único problema real que le queda a esto. Siendo las 3 AM, me dispongo a dormir. Espero que mañana el tema vuele.
