            ...
            <div className="relative group bg-[#404040] rounded-3xl overflow-hidden border border-white/10 shadow-2xl">
                ...
                <div className="absolute inset-0 z-0 flex justify-between items-end pointer-events-none">
                    ...
                    <div className="flex flex-col items-center">
                        ...
                        <div
                            className="bg-white/5 border-r border-t border-white/10"
                    ...
                    <div className="flex flex-col items-center">
                        ...
                        <div
                            className="bg-white/10 border-l border-t border-white/20"
                            style={{ width: dimensions.zoneWidth, height: dimensions.zoneHeight }}
                        />
                    </div>
                </div>
                ...
                <div className="absolute top-6 left-0 right-0 z-30 flex flex-col items-center gap-3">
                    <div className="flex justify-center gap-4">
                        <button
                            ...
                            className="bg-white hover:bg-zinc-200 text-black font-bold py-2 px-6 sm:py-3 sm:px-8 rounded-full shadow-lg shadow-white/10 transition-all transform hover:scale-105 active:scale-95 flex items-center gap-2 text-sm sm:text-base"
                        >
